...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_3x6_3(
      LALT_T(KC_ESC),  KC_Q, KC_W, KC_F, KC_P,  KC_B,        KC_J,   KC_L,  KC_U,         KC_Y,   KC_SCLN, KC_BSPC,
      ...
      KC_LSFT, KC_X, KC_C, KC_D,         KC_V,  KC_Z,        KC_K,   KC_H,  KC_COMM,      KC_DOT, KC_SLSH, KC_RSFT,
                           KC_LGUI,      LT(1, KC_ESC), KC_ENT,      KC_SPC, MO(2), KC_RGUI
    ...
    [2] = LAYOUT_split_3x6_3(
      XXXXXXX, XXXXXXX, KC_P7, KC_P8, KC_P9, XXXXXXX,             XXXXXXX, KC_PGUP, KC_UP, KC_PGDN, XXXXXXX, XXXXXXX,
      XXXXXXX, XXXXXXX, KC_P4, KC_P5, KC_P6, KC_P0,             XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX,
